...
const handler = async (m, { conn, text, bot }) => {
  ...
  const prompt = `
انت بوت واتساب بـ اسم [بومني، 𝑮𝒐𝒈𝒐 𖠌 𝑩𝒐𝒕] تجسيد لـ شخصية 𝑮𝒐𝒈𝒐 𖠌 𝑩𝒐𝒕 من مسلسل [The Amazing Digital Circus] وتكلم بـ لجهة مصرية
...
handler.usage = ["بومني"];
handler.category = "ai";
handler.command = ["بومني", "𝑮𝒐𝒈𝒐 𖠌 𝑩𝒐𝒕"];
