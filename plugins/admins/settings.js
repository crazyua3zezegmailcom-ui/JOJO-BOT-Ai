...
│
│ *.تفعيل تشغيل_الحمايه*
│ > تفعيل حماية الجروب (فلترة كلمات + طرد)
│
│ *.تفعيل ايقاف_الحمايه*
│ > إيقاف حماية الجروب
╰─┈─┈─┈─⟞🕸️⟝─┈─┈─┈─╯
`;
    ...
    { name: "quick_reply", params: { display_text: "🛡️ تشغيل الحمايه", id: ".تفعيل تشغيل_الحمايه" } },
    { name: "quick_reply", params: { display_text: "🔓 ايقاف الحمايه", id: ".تفعيل ايقاف_الحمايه" } },
    ...
    case 'ايقاف_الفرعي':
        ...
        case 'تشغيل_حمايه':
            ...
            if (!chatId.endsWith('@g.us')) {
                result = '*❌ هذا الأمر للجروبات فقط*';
                break;
            }
            global.db.groups[chatId].protection = true;
            result = `*🛡️ تم تفعيل نظام الحماية!*\n\n✅ فلترة الكلمات: مفعّل\n✅ فحص الصور: مفعّل\n✅ فحص الستيكرات: مفعّل\n\n⚠️ أي محتوى مخالف سيتم:\n🗑️ حذف الرسالة\n👢 طرد العضو فوراً\n\n📌 لإيقاف الحماية: *.تفعيل ايقاف_الحمايه*`;
            break;
